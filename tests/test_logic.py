...
class TestNoteCreation(TestCase):
    ...
    def setUpTestData(cls):
        cls.author = User.objects.create(username='Crocodyle')
    ...
    def test_user_can_create_note(self):
        ...
        new_note = Note.objects.order_by('-id')[0]
        for key, value in self.form_data.items():
            with self.subTest(key=key, value=value):
                self.assertEqual(value, getattr(new_note, key))
...
class TestNoteEditDelete(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.note_delete_url = reverse('notes:edit', args=(cls.note.slug,))
    ...
    def test_empty_slug(self):
        ...
        self.assertEqual(new_note.slug, excepted_slug)

    def test_author_user_cat_edit_note(self):
